...
export const EmailChangeEmail = ({ oldEmail, newEmail, confirmationUrl }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your new email for ArabiyaPath</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            You requested to change your ArabiyaPath email address from{' '}
          ...
          <Hr style={hr} />
          <Text style={footer}>
            If you didn't request this change, please secure your account by resetting your password immediately.
          </Text>
        </Section>
