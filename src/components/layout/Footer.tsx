...
const socialLinks = [
  { 
    href: "https://twitter.com/arabiyapath", 
    label: "Twitter",
    icon: (
  ...
  { 
    href: "https://instagram.com/arabiyapath", 
    label: "Instagram",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    href: "https://youtube.com/@arabiyapath", 
    label: "YouTube",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export function Footer() {
  const handleOutboundClick = (destination: string, linkText: string) => {
    trackOutboundClick(destination, linkText);
  };
          ...
          <div className="flex gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                onClick={() => handleOutboundClick(social.href, social.label)}
              >
                {social.icon}
              </a>
            ))}
